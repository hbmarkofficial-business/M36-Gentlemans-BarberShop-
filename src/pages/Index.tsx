  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | M36 Gentlemanshop</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop M36 Gentlemanshop in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="M36 Gentlemanshop | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="M36 Gentlemanshop | Premium Barbershop Berlin" />
        <meta
